...
func (s *implementation) AddProfilePicture(ctx context.Context, id domain.UserID, pictureID string) error {
...
func (s *implementation) GetProfilePictures(ctx context.Context, id domain.UserID) ([]string, error) {
...
func (s *implementation) RemovePicture(ctx context.Context, pictureID string) error {
